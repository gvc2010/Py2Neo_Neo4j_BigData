...
Original file is located at
    https://colab.research.google.com/drive/17hGahltenMMmWLL2Ui9Mj019r8TqXv6b

Entrei em contato diversas vezes com a coordenação do curso para conseguir o acesso a VM. Nínguem pode me ajudar, após todas as etapas o erro persistia, mesmo com as credenciais e os tutoriais sendo seguidos corretamente. Decidi fazer por aqui para não perder nota.
Aluno: Guilherme Venturini de Castro
Curso: Big Data e inteligencia analitica
Neste trabalho estou enviando os arquivos CSV carregados aqui no google coolab para o neo4j que criei pessoalmente. O código foi feito para realizar as consultas.
